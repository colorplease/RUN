...
public class PixelatedCamera : MonoBehaviour
{
    ...
    public float screenScaleFactor = 1;  // Only used with PixelScreenMode.Scale
    float lastScreenScaleFactor;
    ...
    public void Init() {
        ...
        lastScreenScaleFactor = screenScaleFactor;
    ...
    public bool CheckScreenResize() {
        ...
        return Screen.width != screenWidth || Screen.height != screenHeight || screenScaleFactor != lastScreenScaleFactor;
    }
}